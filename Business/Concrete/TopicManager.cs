...
namespace Business.Concrete
{
    public class TopicManager : ITopicService
    {
        ...
        {
            return new SuccessDataResult<List<Topic>>(_topicDal.GetAll(),Messages.Topics_List);
        }

        public IDataResult<Topic> GetById(int id)
        {
            return new SuccessDataResult<Topic>(_topicDal.Get(x => x.Id == id), Messages.Topic_List);
        }
